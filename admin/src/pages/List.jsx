...
const List = ({ token }) => {
  ...
  return (
    <>
      <p className="mb-2 capitalize">all product list</p>
      ...
      <div className="flex flex-col gap-2">
        ...
        {/* product list  */}
         ...
         {
          list.map((item , index) =>
            <div key={index} className='grid grid-cols-[1fr_3fr_1ft] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center gap02 py-1 border text-sm'>
